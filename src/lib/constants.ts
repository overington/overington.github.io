...
export const SITE_DESCRIPTION = process.env.SITE_DESCRIPTION || 'A collection of my thoughts, ideas and learnings.'
...
export const SITE_URL = process.env.SITE_URL || (NODE_ENV === 'production' ? `https://${HOSTNAME}` : `http://${HOSTNAME}:${PORT}`)